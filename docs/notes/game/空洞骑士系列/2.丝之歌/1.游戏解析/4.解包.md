...
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/02c30e14e2.png)

2. 下载后解压到任意目录，打开`AssetStudioModGUI.exe`即可使用   
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/a42b31fe97.png)

---

#### 解包游戏资源
1. 打开AssetStudioModGUI，点击`Options` -> `Import options` ->`Specify Unity version`，设置为`6000.0.50f1`
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/029cc43310.png)

2. 点击`File` -> `Load folder`      
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/13251a070b.png)

3. 选择游戏目录下的`Hollow Knight Silksong\Hollow Knight Silksong_Data\StreamingAssets`文件夹   
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/68e559ede6.png)   

4. 等待加载完成，即可在`Assets List`选项下下看到相应的资源
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/eb1163f8e3.png)
...
1. 点击`Assets List`选项下的资源，重点关注 `Name`,`Container`,`Type`这三个属性
    ...
    ![](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/17c5bbd5ff.png)

2. 如果要导出贴图相关内容，可以点击`Filter Type`选择`Sprite`和`Texture2D`类型
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/5b4b82d4c4.png)
...
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/e61151519d.png)

#### 导出资源
1. 导出设置，一般设置根据`type name`分组导出，也可根据自己的需要     
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/d89996e22b.png)
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/81a396aa53.png)

2. 导出可选择所有素材资源，也可以根据你过滤的内容，也可以是选择的资源，配置导出地址后即可导出       
![alt text](https://pic-1326566629.cos.ap-shanghai.myqcloud.com/notes/cdade93b82.png)
